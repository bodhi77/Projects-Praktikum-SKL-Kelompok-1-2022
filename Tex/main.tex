...
\section{Pengenalan Sistem}
	...
	\begin{frame}{Struktur Fisik}
		\begin{columns}[T] % align columns
			...
			\end{column}
		\end{columns}
>>>>>>> 6a5636d30f6888a904630a79258d86aabc58ad56
\end{frame}
...
%			{Tampilan GUI/GUI.png}}
%		{Video/VideoDemo.mp4}
%	\end{figure}
	\movie[externalviewer]{\includegraphics[width=14.0cm, keepaspectratio]{Tampilan GUI/GUI.png}}{Video/VideoDemo.mp4}
\end{frame}
\section{Penutup}
