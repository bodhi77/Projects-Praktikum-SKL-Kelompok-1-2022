...
\begin{document}
	...
	\begin{frame}{Pengenalan Sistem}
		Feedback Educational Servo ES151 merupakan sebuah modul DC Servo yang digunakan untuk edukasi penerapan kendali posisi dan kecepatan. 
		\newline \includegraphics[width=7.5cm]{Gambar Lain/removed bg-modul.png}
	\end{frame}
...
\begin{frame}{Simulink}
	\begin{columns}[T] % align columns
		...
		\hfill%
		\begin{column}{0.48\textwidth}
			Blok PID & Plant Motor DC
			\color{blue}\rule{\linewidth}{4pt}
			\begin{center}
				\includegraphics[height=5cm]{Matlab/simulink2.jpg}
				\newline \includegraphics[width=7.5cm]{Matlab/simulink3.jpg}
			\end{center}
		\end{column}
	\end{columns}
\end{frame}
