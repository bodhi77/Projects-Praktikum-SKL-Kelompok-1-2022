...
\begin{frame}{Flowchart Kerja Program Pada Alat}
	\centering
	\includegraphics[width=10cm]{Gambar Lain/FlowchartProgram.png}
\end{frame}
...
\begin{frame}{Desain GUI yang Ditargetkan}
	...
	\end{center}
\end{frame}
\begin{frame}{Progress GUI}
	\begin{columns}[T] % align columns
		\begin{column}{0.48\textwidth}
			Tampilan Awal:
			\color{black}\rule{\linewidth}{4pt}
			\includegraphics[width=7.5cm]{Tampilan GUI/beranda.png}
		\end{column}%
		\hfill%
		\begin{column}{0.48\textwidth}
			Serial Plotter:
			\color{blue}\rule{\linewidth}{4pt}
			\begin{center}
				\includegraphics[width=7.5cm]{Tampilan GUI/Splot.png}
			\end{center}
		\end{column}
	\end{columns}
\end{frame}
