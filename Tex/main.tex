...
\begin{frame}{Video LabView}
	\centering	
%	\includemovie{4.5in}{2.5in}{Video/LABVIEW.mp4} 
	\includemedia[
	 width=4.5in,
	 height=2.5in,
	addresource=Video/LABVIEW.mp4,
	flashvars={
		source=Video/LABVIEW.mp4
		}
	]{\includegraphics{Thumbnail/labview.png}}{VPlayer.swf}
\end{frame}
...
\begin{frame}{Video Simulasi GUI Matlab-Arduino}
	\centering
%	\includemovie{2in}{2.8in}{Video/MatlabGUI.mp4}
	\includemedia[
	width=2in,
	height=2.8in,
	addresource=Video/MatlabGUI.mp4,
	flashvars={
		source=Video/MatlabGUI.mp4
	}
	]{\includegraphics{Thumbnail/matlab gui.jpg}}{VPlayer.swf}
\end{frame}
