...
\begin{document}
	...
	\begin{frame}{Pengenalan Sistem}
		Modul DC Servo yang digunakan untuk edukasi penerapan kendali posisi dan kecepatan bla bla bla.....\newline "Kasih Gambar Alatnya di sini (Yang bagusss, angle n pencahayaan baguss)"
	\end{frame}
